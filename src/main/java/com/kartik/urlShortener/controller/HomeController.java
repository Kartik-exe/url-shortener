...
import com.kartik.urlShortener.model.ShortenUrlRequest;
import com.kartik.urlShortener.model.ShortenUrlResponse;
import com.kartik.urlShortener.service.UrlShortenerService;
...
public class HomeController {
     ...
     */
    @PostMapping("/shorten")
    public String shortenUrl(@Valid ShortenUrlRequest request, BindingResult bindingResult, Model model, HttpServletRequest httpRequest) {
